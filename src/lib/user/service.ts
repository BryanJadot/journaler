...
import type { User, CreateUserData, LoginCredentials, AuthenticationResult } from './types';
...
export async function authenticateUser(credentials: LoginCredentials): Promise<AuthenticationResult> {
